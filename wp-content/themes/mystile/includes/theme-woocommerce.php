...
add_action('mystile_homepage_content', 'mystile_recent_products', 9);
...
function woocommerce_cart_link() {
	...
	?>
	<li class="cart">
		<a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'woothemes'); ?>" class="">
			<span>
				<?php
