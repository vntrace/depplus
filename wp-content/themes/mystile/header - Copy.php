		...
		<nav class="col-full" role="navigation">
			<ul class="contact-nav">
				<?php if(is_user_logged_in()): ?>
					...
					?>
					<li>
						Hi <a href="/my-account/" style="text-decoration:underline; color: #FFF"><?php echo $user->display_name; ?></a>
					</li>
					<li>
	...
	<header id="header">
		<div class="col-full">
			...
			<nav id="navigation" class="col-full" role="navigation">
				...
				<div class="contact">
					<a href="tel:(+84)0908151802" class="my_contact">
				    	<i class="fa fa-phone"></i>
				    	(+84) 0908 151 802 | Bé Yến
				    </a>
				</div>
			</nav><!-- /#navigation -->
